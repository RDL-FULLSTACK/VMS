...
// //           ? JSON.stringify(formData.assets)
// //           : JSON.stringify([])
// //       );
...
// //                 (hosts.length === 0 ? "No hosts available" : "")
// //               }
// //               required
// //               sx={{ mb: 2 }}
...
//   // Modal handlers with revert logic
...
//           <Grid item xs={12} sm={6}>
//             {/* Team Members and Assets Dropdowns */}
...
//                   onChange={(e) =>
//                     handleInputChange("hasTeamMembers", e.target.value)
//                   }
...
const Checkin = () => {
  ...
  const handleInputChange = (field, value) => {
    ...
    // Open modals conditionally when "yes" is selected
    if (field === "hasTeamMembers" && sanitizedValue === "yes") {
      setOpenTeamModal(true);
    }
    if (field === "hasAssets" && sanitizedValue === "yes") {
    ...
    <>
      ...
      >
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
            {/* Team Members and Assets Dropdowns with View Buttons */}
