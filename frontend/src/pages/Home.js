...
//       dates.push(date.toISOString().split("T")[0]); // e.g., "2025-03-04"
//     }
//     return dates;
//   };
...
//       const dateRange = getDateRange(7); // Get the last 7 days including today
//       const dailyVisits = visitorData.reduce((acc, visitor) => {
//         const checkInDate = visitor.checkInTime ? extractDateOnly(visitor.checkInTime) : null;
//         if (checkInDate && dateRange.includes(checkInDate)) {
//           const day = new Date(checkInDate).toLocaleDateString("en-US", { day: "numeric", month: "short" });
...
//       setChartData(
//         dateRange.map(date => ({
//           name: new Date(date).toLocaleDateString("en-US", { day: "numeric", month: "short" }), // e.g., "Mar 10"
//           visits: dailyVisits[date] || 0, // Default to 0 if no visits
//         }))
//       );
...
//       ),
//     },
//     { field: "firstName", headerName: "Name", flex: isMobile ? 0 : 1, width: isMobile ? 100 : undefined },
...
function Home() {
  ...
  }, []); // Dependency array is empty, but getDateRange is used inside - see note below
